...
| 13 | Trigger - mail_klik | Custom Event | `mail_klik` |
...
| 14 | GA4 - mail_klik | GA4 Event | Trigger 13 |
...
- `src/app/page.js` — 2x mail_klik op mailto-links
- `src/app/portfolio/page.js` — 1x mail_klik op mailto-link
