...
// ── LOGO (copied from page.js) ───────────────────────────────────────────────
const LOGO_FRAMES = [
  ['#6B3FFF','rgba(107,63,255,0.3)','rgba(107,63,255,0.12)','rgba(107,63,255,0.08)','#6B3FFF','rgba(107,63,255,0.12)','rgba(107,63,255,0.28)','rgba(107,63,255,0.08)','#6B3FFF','rgba(107,63,255,0.08)','rgba(107,63,255,0.12)','#00C8A8','#6B3FFF','#6B3FFF','#6B3FFF','#00C8A8'],
  ['#6B3FFF','#6B3FFF','rgba(107,63,255,0.2)','rgba(107,63,255,0.08)','rgba(107,63,255,0.3)','#6B3FFF','rgba(107,63,255,0.12)','rgba(107,63,255,0.08)','#6B3FFF','rgba(107,63,255,0.2)','#00C8A8','rgba(0,200,168,0.3)','#6B3FFF','#6B3FFF','#00C8A8','#00C8A8'],
  ['rgba(107,63,255,0.4)','#6B3FFF','#6B3FFF','rgba(107,63,255,0.15)','#6B3FFF','rgba(107,63,255,0.2)','#6B3FFF','rgba(107,63,255,0.1)','rgba(107,63,255,0.15)','#6B3FFF','rgba(107,63,255,0.3)','#00C8A8','#6B3FFF','rgba(107,63,255,0.5)','#6B3FFF','#00C8A8'],
  ['#6B3FFF','rgba(107,63,255,0.15)','rgba(107,63,255,0.3)','rgba(107,63,255,0.08)','#6B3FFF','#6B3FFF','rgba(107,63,255,0.1)','rgba(107,63,255,0.12)','#6B3FFF','rgba(107,63,255,0.12)','#6B3FFF','#00C8A8','rgba(107,63,255,0.6)','#6B3FFF','#6B3FFF','#00C8A8'],
];
...
function LogoMark({ size = 'md' }) {
  ...
  return (
    <div style={{ display: 'grid', gridTemplateColumns: `repeat(4, ${cellSize}px)`, gridTemplateRows: `repeat(4, ${cellSize}px)`, gap: `${gap}px`, flexShrink: 0 }}>
      {LOGO_FRAMES[frame].map((color, i) => (
        <div key={i} style={{ background: color, borderRadius: `${radius}px`, width: cellSize, height: cellSize, transition: 'background 0.6s ease' }} />
      ))}
    </div>
  );
}
...
function Logo() {
  return (
    <a href="/" style={{ display: 'flex', alignItems: 'center', gap: 10, textDecoration: 'none' }}>
      <LogoMark />
      <span style={{ fontFamily: 'var(--font-head)', fontWeight: 800, fontSize: '1.05rem', color: 'var(--text)', letterSpacing: '-0.01em', lineHeight: 1.1 }}>
        Lease een<br /><span style={{ background: 'var(--gradient-text)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>Website</span>
      </span>
    </a>
  );
}
  ...
  return (
    <>
        ...
        <div className="container">
          <div className="nav-inner">
            ...
            <ul className="nav-links" role="list">
              ...
              <li><a href="/#contact" className="nav-cta">Start je aanvraag</a></li>
            </ul>
            <button className="nav-hamburger" aria-label="Menu openen" aria-expanded={mobileOpen} onClick={() => setMobileOpen(true)}>
              <span /><span /><span />
            </button>
          </div>
        </div>
      ...
      <nav className={`nav-drawer${mobileOpen ? ' open' : ''}`} aria-label="Mobiel menu">
        <button style={{position:'absolute',top:24,right:24,background:'none',border:'none',color:'var(--text)',cursor:'pointer',fontSize:'1.5rem'}} onClick={() => setMobileOpen(false)} aria-label="Menu sluiten">✕</button>
      ...
      {/* WhatsApp */}
      <a href="https://wa.me/31850806338" className="whatsapp-btn" target="_blank" rel="noopener noreferrer" aria-label="App via WhatsApp">
